...
# Use the environment variable SECRET_KEY, or fallback to a development key
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-cn=sw%39qz_vls80(kqdd6)dj-kb_a4dimz79gla_$znrcf%@@')
